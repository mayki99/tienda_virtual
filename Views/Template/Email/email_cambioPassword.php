        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <p>Has solicitado los datos de tu usuario, accede al enlace de abajo para cambiar tu contraseña.</p>
                    <p class="x_text_white">
                    <a href="<?= $data['url_recovery']; ?>" target="_blank" class="x_button_link x_link_blue">Confirmar datos</a>
                    </p>
                    <br>
                    <p>Si no te funciona el boton puedes copiar y pegar la siguiente dirección en tu navegador.</p>
